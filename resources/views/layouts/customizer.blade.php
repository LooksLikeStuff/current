...
<div class="customizer-setting d-none d-md-block">
    <div class="btn-info rounded-pill shadow-lg btn btn-icon btn-lg p-2" data-bs-toggle="offcanvas"
        data-bs-target="#theme-settings-offcanvas-hidden" aria-controls="theme-settings-offcanvas-hidden">
        <i class='mdi mdi-spin mdi-cog-outline fs-22'></i>
    </div>
</div>

<!-- Theme Settings -->
<div class="offcanvas offcanvas-end border-0" tabindex="-1" id="theme-settings-offcanvas-hidden">
                    ...
                    <div class="d-flex gap-2 flex-wrap img-switch">
                        ...
                        <div class="form-check sidebar-setting card-radio">
                            ...
                            <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-01">
                                <img src="{{ URL::asset('build/images/sidebar/img-1.jpg') }}"
                        ...
                        <div class="form-check sidebar-setting card-radio">
                            ...
                            <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-02">
                                <img src="{{ URL::asset('build/images/sidebar/img-2.jpg') }}"
                                    class="avatar-md w-auto object-fit-cover">
                            </label>
                        </div>
                        <div class="form-check sidebar-setting card-radio">
                            ...
                            <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-03">
                                <img src="{{ URL::asset('build/images/sidebar/img-3.jpg') }}"
                                    class="avatar-md w-auto object-fit-cover">
                            </label>
                        </div>
                        <div class="form-check sidebar-setting card-radio">
                            ...
                            <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-04">
                                <img src="{{ URL::asset('build/images/sidebar/img-4.jpg') }}"
                                    class="avatar-md w-auto object-fit-cover">
                            </label>
                        </div>
                    </div>
