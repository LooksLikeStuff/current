...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        <!-- Dark Logo-->
        <a href="{{route('actives.index')}}" class="logo logo-dark">
            <span class="logo-sm">
                Capital Space
            </span>
            <span class="logo-lg">
    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a href="{{ route('actives.index') }}" class="nav-link menu-link {{Route::is('actives.index') ? 'active' : ''}}">
                        <i class="ri-briefcase-2-line"></i> <span>@lang('Список сделок')</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link menu-link" data-bs-toggle="modal" data-bs-target="#createActiveModal" style="cursor: pointer">
                        <i class="ri-rocket-line"></i><span>@lang('Купить')</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link menu-link" data-bs-toggle="modal" data-bs-target="#sellActiveModal" style="cursor: pointer">
                        <i class="ri-exchange-dollar-line"></i><span>@lang('Продать')</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('tickers.pivot') }}" class="nav-link menu-link {{Route::is('tickers.pivot') ? 'active' : ''}}">
                        <i class="ri-layout-3-line"></i><span>@lang('Сводная таблица')</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('tickers.index') }}" class="nav-link menu-link {{Route::is('tickers.index') ? 'active' : ''}}">
                        <i class="ri-share-line"></i><span>@lang('Курсы на дату')</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('instructions') }}" class="nav-link menu-link {{Route::is('instructions') ? 'active' : ''}}">
                        <i class="ri-pages-line"></i> <span>@lang('Инструкции')</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('test.cache') }}" class="nav-link menu-link {{Route::is('test.cache') ? 'active' : ''}}">
                        <i class="ri-compasses-2-line"></i> <span>@lang('Контрольные значения')</span>
                    </a>
                </li>

{{--                <li class="nav-item">--}}
{{--                    <a class="nav-link menu-link" href="#sidebarDashboards" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarDashboards">--}}
{{--                        <i class="las la-tachometer-alt"></i> <span>@lang('Портфель')</span>--}}
{{--                    </a>--}}
{{--                    <div class="collapse menu-dropdown" id="sidebarDashboards">--}}
{{--                        <ul class="nav nav-sm flex-column">--}}
{{--                            <li class="nav-item">--}}
{{--                                <a href="#" class="nav-link" data-bs-toggle="modal" data-bs-target="#createActiveModal">@lang('Новый актив')</a>--}}
{{--                            </li>--}}
{{--                            <li class="nav-item">--}}
{{--                                <a href="dashboard-analytics" class="nav-link">@lang('analytics')</a>--}}
{{--                            </li>--}}
{{--                            <li class="nav-item">--}}
{{--                                <a href="dashboard-crm" class="nav-link">@lang('crm')</a>--}}
{{--                            </li>--}}
{{--                            <li class="nav-item">--}}
{{--                                <a href="index" class="nav-link">@lang('ecommerce')</a>--}}
{{--                            </li>--}}
{{--                            <li class="nav-item">--}}
{{--                                <a href="dashboard-crypto" class="nav-link">@lang('crypto')</a>--}}
{{--                            </li>--}}
{{--                            <li class="nav-item">--}}
{{--                                <a href="dashboard-projects" class="nav-link">@lang('projects')</a>--}}
{{--                            </li>--}}
{{--                            <li class="nav-item">--}}
{{--                                <a href="dashboard-nft" class="nav-link"> @lang('nft') </a>--}}
{{--                            </li>--}}
{{--                            <li class="nav-item">--}}
{{--                                <a href="dashboard-job" class="nav-link">@lang('job')</a>--}}
{{--                            </li>--}}
{{--                        </ul>--}}
{{--                    </div>--}}
