...
@endsection
@vite(['resources/custom-js/diagrams/actives/main.js'])


{{--@section('script')--}}
{{--    <script src="{{asset('build/js/actives/main.js')}}"></script>--}}
{{--    <script src="{{asset('build/js/tickers/main.js')}}"></script>--}}
{{--    <script src="{{asset('build/js/diagrams/')}}"></script>--}}
{{--@endsection--}}

@section('content')

@include('actives.create')
@include('actives.sell')
...
{{--            </div> <!-- end row-->--}}
            ...
            <div class="row">
                <div class="actives__content col-xl-12">
                    @include('actives.components.content')
                </div> <!-- .col-->
            </div> <!-- end row-->

            <div class="row">
                @include('diagrams.actives.index')<!-- end col -->
...
{{--                            <div id="sales-by-locations" data-colors='["--vz-light", "--vz-warning", "--vz-primary"]' style="height: 269px" dir="ltr"></div>--}}
