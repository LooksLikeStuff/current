...
<div class="card">
    <div class="card-header align-items-center d-flex">
        <h4 class="card-title mb-0 flex-grow-1">Ваши активы @isset($date) на {{\App\Http\Services\DateService::getDefaultFormat($date)}} @endisset</h4>
                ...
                @isset($date)
                    <thead>
                        <tr>
                            ...
                            <th>Цена за шт.</th>
                            <th>Общая сумма</th>
                            <th class="text-center">Цена за шт. за <br>{{ \App\Http\Services\DateService::getDefaultFormat($date) }}</th>
                            <th class="text-center">Общая сумма за <br>{{ \App\Http\Services\DateService::getDefaultFormat($date) }}</th>
                    ...
                    @foreach($actives as $active)
                        <tr class="align-middle">
                            ...
                            <td class="text-nowrap">{{ \App\Http\Services\DateService::getDefaultFormat($active->date) }}</td>
                    ...
                    <tr>
                        ...
                        <th class="text-end fw-bold {{ $fullPriceNow > 0 ? 'text-success' : 'text-danger' }}">
